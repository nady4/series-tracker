...
<p align="center">
📺 Server-rendered TV-show tracker with daily, LLM-driven news checks for new-season announcements and premiere dates. Built with Next.js and Drizzle ORM on libsql/Turso, deployed with Vercel Cron.
</p>
